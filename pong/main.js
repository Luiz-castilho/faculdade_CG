...
function handleColision(txBola, tyBola) {
    /*
     -0.05, 0.2,
     -0.05, -0.2,
      0.05, 0.2,
   ...
   //  
    ...
    else if (txBola + 0.05 >= 0.85 && tyBola >= tyBD - 0.2 && tyBola <= tyBD + 0.2) {
...
function moveBarraEsquerda(value) {
    tyBE = Math.max(-0.8, Math.min(0.8, tyBE + value));
    MbarraEsquerda = m3.translation(-0.9, tyBE);
}

function moveBarraDireita(value) {
    tyBD = Math.max(-0.8, Math.min(0.8, tyBD + value));
...
function keyHandler(event) {
    switch (event.key) {
        case "w":
            moveBarraEsquerda(0.1)
            break;
        case "s":
            moveBarraEsquerda(-0.1)
            break;
        case "ArrowUp":
            moveBarraDireita(0.1)
            break;
        case "ArrowDown":
            moveBarraDireita(-0.1)
            break;
